    ...
    <section class="auth-section">
        <div class="container auth-container">
            <div class="row align-items-center h-100">
				...
				<h2>{{ __('Welcome to NMPL Meet') }}</h2>
                                <h3>{{ __('Get going!') }}</h3>
                                {{ __('Don\'t have an account yet?') }}<br /><a href="{{ route('register') }}"
                                    class="white-text"><u>{{ __('Sign Up') }}</u></a>
                            </div>
                                ...
                                <div class="card-body">
                                    <form id="login" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group row mb-0">
                                         ...
                                         <button onclick="window.location.href='/register'" class="btn btn-primary mb-2">
                                                 Sign Up
                                                </button>

<button  type="reset" onclick="location.href = '/login/facebook';" class="loginBtn loginBtn--facebook">
  Login with Facebook
</button>

<button type="reset" onclick="location.href = '/login/google';" class="loginBtn loginBtn--google">
  Login with Google
</button>
