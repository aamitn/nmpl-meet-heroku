...
@section('content')
    <section class="dashboard-section">
		...
		{!! getContent('HOME_PAGE') !!}<br>
		<<a style="font-size:2.5vw; text-decoration-line: underline;
  text-decoration-color: red;
  text-decoration-style: double;
  text-decoration-thickness: 0.5vw; background: rgba(238,111,87,0.5);" href="https://enempl.com" class="typewrite" data-period="2000" data-type='[ "Meetings.", "Webinars.", "Classrooms.", "Sessions." ]'>
    		<span class="wrap"></span> </a>> <br>
				<img src="https://meet.enempl.com/images/appa.png" style="width:5vwpx;height:5vw;">	
				<img src="https://meet.enempl.com/images/appi.svg" style="width:3.5vwpx;height:3.5vw;">	
                       <div style="font-size:2vw;">Download the app today!</div><br>
            ...
            <div class="entering-info">              
			  ...
			  <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="submit" id="initiate"
                                title="{{ __('Start your  meeting now!') }}"><i class="fa fa-arrow-right"></i></button>
                        </div>
                    </div>          
		</form>
            </div>
            ...
            <div class="container pb-5 about-data">
                <div class="row align-items-center pb-5 mt-5">
                    <div class="col-12 col-lg-6">
                        <h1 class="main-title w-100 text-left ">{{ __('About NMPL Meet') }}</h1>
